...
// const imagePaths = { "Single-line input": [image, image], 
// // "Password input": [passimg, passimg], 
...
//                   )}
//                   {/* Render images if found in imagePaths */}
//                   {selectedVariant && imagePaths[selectedVariant]?.length > 0 && (
